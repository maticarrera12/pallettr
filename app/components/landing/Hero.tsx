...
const Hero = () => {
  ...
  return (
    <div id="home" className="flex flex-col min-h-dvh w-full max-w-full overflow-hidden relative lg:flex-row px-4 sm:px-6 lg:px-8">
      <div className="hero-section flex-1 flex flex-col  items-start sm:px-4 lg:px-8 relative z-10">
        <div className="w-full max-w-4xl">
          ...
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-theme mb-4 max-w-3xl break-words leading-relaxed font-medium opacity-90">
            Bring your ideas to life with <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">AI-powered color palettes</span>, ready to
            use in your code and <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">designed for perfect accessibility</span>.
          </p>
